...
Aditya Mukerjee: Standard library functions (pure Lisp implementation), fixed-point combinator, testing framework, fixes to the interpreter, repository sanitization
